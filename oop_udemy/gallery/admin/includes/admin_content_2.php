<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <p class="bg-primary"> Enable "find_this_query" METHOD 1 on user.php to work the below functions</p>

            <h3>Found user details with ID - Method 2 - Myself (Auto Instantation - Loop)</h3>

            <?php

            $users_found = User::find_user_by_id(2);
            $results = User::instantation_two($users_found);
