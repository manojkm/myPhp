...
class Photo extends Db_object
{
    ...
    protected static $db_table_fields = array('id', 'title', 'caption', 'filename', 'alternate_text', 'type', 'size', 'description');
    public $id;
    public $title;
    public $caption;
    public $filename;
...
//    This is passing $_FILES['uploaded_file'] as an argument
    ...
    {
        // Meaning, If file is empty OR Not file OR Not an array
    ...
    public function save()
    {
        ...
        if ($this->id) {
            ...
            if (file_exists($target_path)) {
                $this->errors[] = "The file {$this->filename} aleady exist";
                return false;
            }
...
//                 predefined function to delete file
